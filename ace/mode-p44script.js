...
var cFunctions = exports.cFunctions = "\\b(?:abort|abs|after_time|await|between_dates|cyclic|dawn|day|delay|dusk|elements|epoch(?:time|days)|error(?:code|domain|message)?|eval|every|find|format|formattime|frac|hour|if|ifvalid|initial|int|is_time|is_weekday|isvalid|json|jsonresource|lastarg|limited|log|loglevel(?:offset)?|macaddress|max|min|minute|month|nextversion|number|productversion|random|round|second|signal|string|strlen|substr|sunrise|sunset|testlater|throw|timeofday|undeclare|weekday|year|yearday|runafter|repeat|function|from|runto|stop)\\b";
